...
We performed a linear regression in order to analyze whether the length of a trout perch predicts its weight, our null hypothesis being that the length is not an accurate predictor of its weight. Based on our observations, 
